...
def main():
    ...
    weekly_response, ingestion_results = r.get_report(start_date, end_date, 'weekly')
    ...
    if time_to_generate_monthly_report(today):
        ...
        monthly_response, ingestion_results = r.get_report(last_month_first_date,
                                                           last_month_end_date, 'monthly')
